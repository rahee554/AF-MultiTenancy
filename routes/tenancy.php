...
Route::middleware(['web', 'auth'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Tenant Operations
    Route::post('/tenants/{uuid}/activate', [TenantViewController::class, 'activate']);
    Route::post('/tenants/{uuid}/suspend', [TenantViewController::class, 'suspend']);
    Route::post('/tenants/{uuid}/migrate', [TenantViewController::class, 'migrateTenant']);
    Route::post('/tenants/{uuid}/seed', [TenantViewController::class, 'seedTenant']);
    Route::post('/tenants/{uuid}/status', [TenantViewController::class, 'updateStatus']);
    Route::post('/tenants/{uuid}/reset', [TenantViewController::class, 'resetTenant']);
    Route::post('/tenants/{uuid}/domains', [TenantViewController::class, 'addDomain']);
    ...
    Route::get('/stats', [TenantViewController::class, 'stats']);
    Route::get('/health', [TenantViewController::class, 'health']);
    Route::get('/performance', [TenantViewController::class, 'performance']);
    Route::get('/live-stats', [TenantViewController::class, 'liveStats']);
    Route::get('/connections', [TenantViewController::class, 'connectionStats']);
    Route::get('/active-users', [TenantViewController::class, 'activeUsers']);
    
    // Advanced Monitoring
    Route::prefix('monitoring')->name('monitoring.')->group(function () {
        Route::get('/dashboard', [TenantViewController::class, 'monitoringDashboard'])->name('dashboard');
