...
**Version: 0.4.5** | **Updated: August 1, 2025**
...
- **Multi-database Architecture** - Each tenant gets isolated database
- **Domain Management** - Full custom domain support per tenant
- **Tenant Status Management** - Active, suspended, blocked, inactive states
