                            ...
                            <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                                ...
                                <div>
                                    <div class="flex space-x-2">
                                        <a href="{{ route('tenancy.admin.tenants.show', $tenant) }}" 
                                           class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                            View
                                        </a>
                                        <a href="{{ route('tenancy.admin.tenants.edit', $tenant) }}" 
...
function confirmDelete(tenantId, tenantName) {
    ...
    document.getElementById('deleteForm').action = `{{ route('tenancy.admin.tenants.index') }}/${tenantId}`;
