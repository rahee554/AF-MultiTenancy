<div @if($isCreating && $jobId) wire:poll.2s="checkProgress" @endif>
    <!--begin::Toolbar-->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group mb-8">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   placeholder="tenant_example_com">
                                            <div class="form-text">If left empty the database will be empty; otherwise auto-prefixed with <code>tenant_</code> and slugified from the tenant name.</div>
                                            @error('databaseName')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <!--begin::Form Group-->
                                        <div class="form-group mb-8">
                                            <label class="fs-6 fw-semibold form-label">Custom Database Name</label>
                                            <!-- customDatabase removed: single databaseName input above is used -->
                                        </div>
                                        <!--end::Form Group-->
